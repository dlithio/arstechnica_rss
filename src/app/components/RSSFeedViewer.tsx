      ...
      {feed && (
        <div>
          ...
          {blockedCategories.length > 0 && (
            <div className="mt-10 p-4 bg-[var(--blocked-bg)] rounded-lg border border-[var(--blocked-border)]">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-sm font-medium text-[var(--blocked-text)]">Blocked Categories</h3>
                <button
                  className="text-xs text-[var(--blocked-text)] hover:opacity-80"
                  onClick={clearBlockedCategories}
                >
                  Clear All
                </button>
              ...
              <p className="text-xs text-[var(--blocked-text)] mt-2">
                {feed &&
